...
"""autogenerated by genpy from calibration_msgs/CheckerboardExtractionActionResult.msg. Do not edit."""
import sys
...
class CheckerboardExtractionActionResult(genpy.Message):
  _md5sum = "2e18f373b65d4f581d583d4186af5525"
  _type = "calibration_msgs/CheckerboardExtractionActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','calibration_msgs/CheckerboardExtractionResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CheckerboardExtractionActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = calibration_msgs.msg.CheckerboardExtractionResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = calibration_msgs.msg.CheckerboardExtractionResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.result.image_corners)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.image_corners:
        _v1 = val1.header
      ...
      length = len(self.result.depth_points)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.depth_points:
        _v3 = val1.header
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.result.image_corners.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.result.depth_points = []
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          val1.points.append(val2)
        self.result.depth_points.append(val1)
      return self
