...
class CalibrationPose {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new CalibrationPose(null);
  ...
  static datatype() {
    ...
    return 'calibration_msgs/CalibrationPose';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '54f07abf120bf412d0eaf679e859e412';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CalibrationPose(null);
...
module.exports = CalibrationPose;
