...
let CheckerboardExtractionResult = require('./CheckerboardExtractionResult.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class CheckerboardExtractionActionResult {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('result')) {
        ...
        this.result = new CheckerboardExtractionResult();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = CheckerboardExtractionResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new CheckerboardExtractionActionResult(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [status]
    data.status = actionlib_msgs.msg.GoalStatus.deserialize(buffer, bufferOffset);
    // Deserialize message field [result]
    data.result = CheckerboardExtractionResult.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += CheckerboardExtractionResult.getMessageSize(object.result);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CheckerboardExtractionActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = CheckerboardExtractionResult.Resolve(msg.result)
    }
    else {
      resolved.result = new CheckerboardExtractionResult()
    }
...
module.exports = CheckerboardExtractionActionResult;
