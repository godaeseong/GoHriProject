...
if(calibration_pcl_CONFIG_INCLUDED)
  return()
endif()
set(calibration_pcl_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(calibration_pcl_SOURCE_PREFIX /home/hri/catkin_ws/src/calibration_toolkit/calibration_pcl)
  set(calibration_pcl_DEVEL_PREFIX /home/hri/catkin_ws/devel/.private/calibration_pcl)
  set(calibration_pcl_INSTALL_PREFIX "")
  set(calibration_pcl_PREFIX ${calibration_pcl_DEVEL_PREFIX})
else()
  set(calibration_pcl_SOURCE_PREFIX "")
  set(calibration_pcl_DEVEL_PREFIX "")
  set(calibration_pcl_INSTALL_PREFIX /home/hri/catkin_ws/install)
  set(calibration_pcl_PREFIX ${calibration_pcl_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'calibration_pcl' is deprecated")
...
set(calibration_pcl_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/hri/catkin_ws/src/calibration_toolkit/calibration_pcl/include;/usr/include;/usr/include/pcl-1.7;/usr/include/eigen3;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.2;/usr/include/freetype2;/usr/include/x86_64-linux-gnu/freetype2;/usr/include/x86_64-linux-gnu;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent/include;/usr/lib/openmpi/include;/usr/lib/openmpi/include/openmpi;/usr/include/python2.7;/usr/include/libxml2;/usr/include/jsoncpp;/usr/include/hdf5/openmpi;/usr/include/tcl " STREQUAL " ")
  set(calibration_pcl_INCLUDE_DIRS "")
  set(_include_dirs "/home/hri/catkin_ws/src/calibration_toolkit/calibration_pcl/include;/usr/include;/usr/include/pcl-1.7;/usr/include/eigen3;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.2;/usr/include/freetype2;/usr/include/x86_64-linux-gnu/freetype2;/usr/include/x86_64-linux-gnu;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent/include;/usr/lib/openmpi/include;/usr/lib/openmpi/include/openmpi;/usr/include/python2.7;/usr/include/libxml2;/usr/include/jsoncpp;/usr/include/hdf5/openmpi;/usr/include/tcl")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'Filippo Basso <bassofil@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${calibration_pcl_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'calibration_pcl' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'calibration_pcl' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hri/catkin_ws/src/calibration_toolkit/calibration_pcl/${idir}'.  ${_report}")
    endif()
    _list_append_unique(calibration_pcl_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND calibration_pcl_LIBRARIES ${library})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/hri/catkin_ws/devel/.private/calibration_pcl/lib;/home/hri/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(calibration_pcl_LIBRARY_DIRS ${lib_path})
      list(APPEND calibration_pcl_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'calibration_pcl'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND calibration_pcl_LIBRARIES ${lib})
    endif()
  endif()
...
set(calibration_pcl_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${calibration_pcl_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "calibration_common")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 calibration_pcl_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${calibration_pcl_dep}_FOUND)
      find_package(${calibration_pcl_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${calibration_pcl_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(calibration_pcl_INCLUDE_DIRS ${${calibration_pcl_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(calibration_pcl_LIBRARIES ${calibration_pcl_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${calibration_pcl_dep}_LIBRARIES})
  _list_append_deduplicate(calibration_pcl_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(calibration_pcl_LIBRARIES ${calibration_pcl_LIBRARIES})

  _list_append_unique(calibration_pcl_LIBRARY_DIRS ${${calibration_pcl_dep}_LIBRARY_DIRS})
  list(APPEND calibration_pcl_EXPORTED_TARGETS ${${calibration_pcl_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${calibration_pcl_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
