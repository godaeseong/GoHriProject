...
(cl:in-package google_cloud_speech-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <RecognizedWord>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RecognizedWord)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name google_cloud_speech-msg:<RecognizedWord> is deprecated: use google_cloud_speech-msg:RecognizedWord instead.")))

(cl:ensure-generic-function 'recognized_word-val :lambda-list '(m))
(cl:defmethod recognized_word-val ((m <RecognizedWord>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader google_cloud_speech-msg:recognized_word-val is deprecated.  Use google_cloud_speech-msg:recognized_word instead.")
  (recognized_word m))

(cl:ensure-generic-function 'confidence-val :lambda-list '(m))
(cl:defmethod confidence-val ((m <RecognizedWord>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader google_cloud_speech-msg:confidence-val is deprecated.  Use google_cloud_speech-msg:confidence instead.")
  (confidence m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RecognizedWord>)))
  ...
  "google_cloud_speech/RecognizedWord")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RecognizedWord)))
  "Returns string type for a message object of type 'RecognizedWord"
  "google_cloud_speech/RecognizedWord")
