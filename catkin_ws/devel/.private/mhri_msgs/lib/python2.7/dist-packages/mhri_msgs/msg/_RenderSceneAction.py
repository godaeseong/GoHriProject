...
"""autogenerated by genpy from mhri_msgs/RenderSceneAction.msg. Do not edit."""
import sys
...
class RenderSceneAction(genpy.Message):
  _md5sum = "b14cb2fd117e80570646254f4206df89"
  _type = "mhri_msgs/RenderSceneAction"
...
"""
  ...
  _slot_types = ['mhri_msgs/RenderSceneActionGoal','mhri_msgs/RenderSceneActionResult','mhri_msgs/RenderSceneActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RenderSceneAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = mhri_msgs.msg.RenderSceneActionGoal()
      if self.action_result is None:
        self.action_result = mhri_msgs.msg.RenderSceneActionResult()
      if self.action_feedback is None:
        self.action_feedback = mhri_msgs.msg.RenderSceneActionFeedback()
    else:
      self.action_goal = mhri_msgs.msg.RenderSceneActionGoal()
      self.action_result = mhri_msgs.msg.RenderSceneActionResult()
      self.action_feedback = mhri_msgs.msg.RenderSceneActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.render_scene
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_B().pack(self.action_feedback.feedback.is_rendering))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.render_scene = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.render_scene = str[start:end]
      _x = self
      start = end
      end += 12
      ...
      (self.action_feedback.feedback.is_rendering,) = _get_struct_B().unpack(str[start:end])
      self.action_feedback.feedback.is_rendering = bool(self.action_feedback.feedback.is_rendering)
      return self
