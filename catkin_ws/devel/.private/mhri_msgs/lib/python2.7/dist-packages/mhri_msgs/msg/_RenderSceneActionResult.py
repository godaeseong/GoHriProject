...
"""autogenerated by genpy from mhri_msgs/RenderSceneActionResult.msg. Do not edit."""
import sys
...
class RenderSceneActionResult(genpy.Message):
  _md5sum = "e5f62eb2cecdccdb33834c1bf0d40a1c"
  _type = "mhri_msgs/RenderSceneActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','mhri_msgs/RenderSceneResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RenderSceneActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = mhri_msgs.msg.RenderSceneResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = mhri_msgs.msg.RenderSceneResult()
