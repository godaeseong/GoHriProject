...
"""autogenerated by genpy from polly_speech/SpeechAction.msg. Do not edit."""
import sys
...
import polly_speech.msg
import std_msgs.msg

class SpeechAction(genpy.Message):
  _md5sum = "478fe8833e40cc0e66f5c2bbb173509f"
  _type = "polly_speech/SpeechAction"
...
"""
  ...
  _slot_types = ['polly_speech/SpeechActionGoal','polly_speech/SpeechActionResult','polly_speech/SpeechActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SpeechAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = polly_speech.msg.SpeechActionGoal()
      if self.action_result is None:
        self.action_result = polly_speech.msg.SpeechActionResult()
      if self.action_feedback is None:
        self.action_feedback = polly_speech.msg.SpeechActionFeedback()
    else:
      self.action_goal = polly_speech.msg.SpeechActionGoal()
      self.action_result = polly_speech.msg.SpeechActionResult()
      self.action_feedback = polly_speech.msg.SpeechActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_B().pack(self.action_feedback.feedback.is_speaking))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.action_feedback.feedback.is_speaking,) = _get_struct_B().unpack(str[start:end])
      self.action_feedback.feedback.is_speaking = bool(self.action_feedback.feedback.is_speaking)
      return self
