...
"""autogenerated by genpy from polly_speech/SpeechActionResult.msg. Do not edit."""
import sys
...
class SpeechActionResult(genpy.Message):
  _md5sum = "e5f62eb2cecdccdb33834c1bf0d40a1c"
  _type = "polly_speech/SpeechActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','polly_speech/SpeechResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SpeechActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = polly_speech.msg.SpeechResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = polly_speech.msg.SpeechResult()
