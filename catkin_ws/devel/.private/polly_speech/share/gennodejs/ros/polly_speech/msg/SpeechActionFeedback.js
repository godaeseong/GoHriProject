...
class SpeechActionFeedback {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = SpeechFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new SpeechActionFeedback(null);
    ...
    data.feedback = SpeechFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SpeechActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = SpeechFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new SpeechFeedback()
    }
...
module.exports = SpeechActionFeedback;
