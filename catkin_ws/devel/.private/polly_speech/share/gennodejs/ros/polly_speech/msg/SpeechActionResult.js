...
class SpeechActionResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = SpeechResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SpeechActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = SpeechResult.Resolve(msg.result)
    }
    else {
      resolved.result = new SpeechResult()
    }
...
module.exports = SpeechActionResult;
